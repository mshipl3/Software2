 ...
 *
 * @author shipleym
 * this routine handles initialization of Logger class and gets called in main method
...
public class LoggerUtil {
 ...
 public static void init(){
    try {
    handler = new FileHandler("MShipleySchedulingCS195-Userlog.%u.%g.txt", 1024 * 1024, 10, true);
